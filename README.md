...
> На данный момент работает только в 1 поток из-за капчи VK — при создании нескольких соединений VK требует прохождение капчи, что блокирует многопоточный режим.
...
3. Заполните настройки:
   ...
   - **Ссылка** — ссылка VK Звонка или Yandex Telemost
